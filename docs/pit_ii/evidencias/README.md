# Evidências técnicas de execução — PIT II

Capturas produzidas em 20/08/2026, em ambiente local com banco PostgreSQL temporário e dados de teste.

| Arquivo | Evidência |
| --- | --- |
| `01-login.png` | Tela de autenticação. |

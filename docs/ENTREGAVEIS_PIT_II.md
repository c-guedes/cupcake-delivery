...
1. Mesclar a branch `pit-ii-documentacao-validacao` na `main` e confirmar a visibilidade pública do repositório.
2. Hospedar front-end e API, configurar a URL da API do front-end e inserir o link público neste arquivo e no DOCX.
3. Aplicar o formulário a cinco participantes reais, gerar os cinco PDFs assinados/preenchidos e completar o laudo de qualidade.
4. Gravar o vídeo narrado mostrando: login, catálogo, criação do pedido, painel administrativo, entrega, testes e documentação.
